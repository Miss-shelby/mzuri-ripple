...
const Layout = ({ children }) => {
  ...
  return (
    <div className="w-full bg-[#fafafa] mt-[6rem] grid sm:grid-cols-2 lg:grid-cols-3  grid-cols-1 gap-6   
    max-w-[1920px] mx-auto min-h-screen border
     border-t-2 px-[1rem] md:px-[5rem] ">
      ...
      <div className="grid grid-cols-1  h-full gap-4 md:gap-8">
        ...
        <div className="py-1 z-[10] lg:col-span-2">{children}</div>
    </div>
  );
};
