  ...
  return (
    <div className='flex flex-col lg:flex-row justify-center items-center pb-[67px] pt-[62px]'>
        ...
        <Formik initialValues={defaultValues} onSubmit={onSubmitHandler}>
          ...
          <Form className='bg-custom-green flex flex-col px-[30px] w-full lg:w-[26rem]'>
              ...
              <div className='flex justify-between flex-wrap mt-7 items-center relative'>
              ...
              className={`btn ${loading ? 'bg-gray-400' : 'bg-custom-blue'}
               hover:bg-custom-blue text-white w-full lg:w-[10.5rem] lg:text-lg text-base  font-medium text-center 
               mx-auto mt-6 h-10 min-h-10 `}
          ...
          "Login"
              ...
              <button className='btn bg-custom-red hover:bg-custom-red text-white w-full lg:text-lg text-base 
               font-medium text-center mx-auto mt-6 lg:h-10 lg:min-h-10  lg:py-0'>
              Continue with Google</button>
              <button className='btn bg-custom-blue-100 hover:bg-custom-blue-100 text-white w-full lg:text-lg text-base 
               font-medium text-center mx-auto mt-6 lg:h-10 lg:min-h-10'>
