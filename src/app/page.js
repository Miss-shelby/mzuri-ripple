...
export default function Home() {
  return (
    <main className="pt-[8.8rem] w-full ">
      <p className="text-6xl text-black-100 leading-[4rem] font-medium">
        Discover The Best and <span className="block"> brightest Projects</span>
      </p>
      ...
      <p className="text-center font-medium text-lg  pt-20 pb-7">Within The Last Day</p>
      <div className="bg-[#F5F5F5] flex justify-between px-[3rem] w-full py-4 mb-[4rem]">
        ...
        <div className="inline-block border-l border-1 h-15 border-[#525252] ml-2"> </div > 
        <div className="flex flex-col items-center justify-center text-black-100">
      ...
      <RecommendedProjects/>
      <div>
        <h5 className="text-black-100 text-4xl font-[700] pt-20">Don’t miss new wonderful Projects</h5>
        <p className="text-black-100 font-medium text-2xl pt-6">Sign up for new projects and updates</p>
