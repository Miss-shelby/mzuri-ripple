...
const FilterProjects = ({allProjects}) => { 
  ...
  return (
    ...
    <input
      ...
      className="shadow-xl bg-[#F1F1F1] focus:outline-none text-[#242323] mt-2 lg:mt-0 w-full lg:w-[25rem] pl-4 py-2 rounded-[3px]"
    />
  ...
  <ul className={`transition-all duration-1000 ease-in-out ${filteredProjects.length > 0 ? 'opacity-100 max-h-screen' : 'opacity-0 max-h-0'}
   shadow-xl rounded-sm
  h-auto z-50 lg:w-[25rem] overflow-hidden`}>
